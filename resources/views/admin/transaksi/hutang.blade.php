...
<div x-data="{ modalDetail: false, modalUpdate: false }" 
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 w-full">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Hutang</h2>
        </div>
        ...
        <table class="w-full text-left border-collapse whitespace-nowrap min-w-[1200px]">
            <thead>
                <tr class="text-gray-800 text-sm font-bold border-b-2 border-gray-100">
                    <th class="px-6 py-4">Kode Beli</th>
                    <th class="px-6 py-4">Supplier</th>
                    <th class="px-6 py-4">Tgl Hutang</th>
                    <th class="px-6 py-4">Jth Tempo</th>
                    <th class="px-6 py-4">Jml Hutang</th>
            ...
            <tbody class="text-sm text-gray-600">
                ...
                <tr class="border-b border-gray-50 even:bg-gray-50/70 hover:bg-orange-50/40 transition-colors duration-200 animate-fade-in-up delay-{{ $i * 100 }}">
                    <td class="px-6 py-5 font-medium text-gray-700">PB-000002</td>
                    <td class="px-6 py-5 font-medium text-gray-700">HSM Family</td>
                    <td class="px-6 py-5 text-gray-500">04-11-2026</td>
                    <td class="px-6 py-5 text-gray-500">04-11-2026</td>
                    <td class="px-6 py-5 font-bold">4.560.000</td>
                    <td class="px-6 py-5 font-bold">7.000.000</td>
                    <td class="px-6 py-5 text-gray-800">45</td>
                    <td class="px-6 py-5 font-semibold">
                        @if($i % 2 != 0)
                            <span class="bg-[#10B981] text-white px-3 py-1.5 rounded-md text-xs shadow-sm">Lunas</span>
                        @else
                            <span class="bg-[#EF4444] text-white px-3 py-1.5 rounded-md text-xs shadow-sm">Belum Lunas</span>
                        @endif
                    </td>
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="bg-red-50 border border-red-100 rounded-xl p-4 mb-4">
                    <div class="flex justify-between text-sm mb-1">
                        <span class="text-gray-600">Supplier:</span><span class="font-bold text-gray-800">HSM Family</span>
                    </div>
                    <div class="flex justify-between text-sm mb-1">
                        <span class="text-gray-600">Sisa Hutang Saat Ini:</span><span class="font-bold text-red-600">Rp 4.560.000</span>
                    </div>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nominal Pembayaran (Rp) <span class="text-red-500">*</span></label>
                    <input type="number" min="1" placeholder="Masukkan jumlah yang dibayar..." required
                           class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:border-[#E65C00] focus:ring-1 focus:ring-[#E65C00] text-lg font-bold">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Keterangan / Catatan</label>
                    <textarea rows="2" placeholder="Contoh: Pembayaran termin 1 via Transfer BNI..." class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#E65C00] focus:ring-1 focus:ring-[#E65C00]"></textarea>
                </div>
        ...
        <div class="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-6 md:p-8 mt-8 mb-8" @click.away="modalDetail = false"
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm font-bold text-gray-700">Faktur: PB-000002</span>
                    <span class="text-sm font-bold text-[#10B981]">Status Pembayaran</span>
                </div>
                    ...
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        ...
                        <tbody>
                            <tr class="border-b border-gray-50">
                                <td class="p-3 text-gray-600">05 Nov 2026</td>
                                <td class="p-3 font-bold text-gray-800">Rp 3.000.000</td>
                                <td class="p-3 text-gray-500">DP Awal via Transfer</td>
                            </tr>
                            <tr class="border-b border-gray-50">
                                <td class="p-3 text-gray-600">10 Nov 2026</td>
                                <td class="p-3 font-bold text-gray-800">Rp 4.000.000</td>
                                <td class="p-3 text-gray-500">Pelunasan Cash</td>
                            </tr>
                        </tbody>
                        <tfoot class="bg-gray-50 font-bold text-gray-800">
                            <tr>
                                <td class="p-3 text-right">TOTAL DIBAYAR:</td>
                                <td colspan="2" class="p-3 text-[#E65C00]">Rp 7.000.000</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
