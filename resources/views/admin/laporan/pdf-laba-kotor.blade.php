    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th class="text-right" style="width: 17%;">Pendapatan (Masuk)</th>
                <th class="text-right" style="width: 18%;">HPP/Pembelian (Keluar)</th>
            </tr>
        </thead>
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center" style="color: #999; padding: 20px;">Tidak ada transaksi laba kotor pada periode ini.</td>
            </tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr style="background-color: #fafafa; font-weight: bold;">
                <td colspan="5" class="text-right font-bold" style="font-size: 10px; border-top: 1px solid #eee;">TOTAL</td>
                <td class="text-right font-bold text-green" style="font-size: 10px; border-top: 1px solid #eee;">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</td>
                <td class="text-right font-bold text-red" style="font-size: 10px; border-top: 1px solid #eee;">Rp {{ number_format($totalHPP, 0, ',', '.') }}</td>
            </tr>
            <tr style="background-color: #fff8f5; font-weight: bold;">
                <td colspan="5" class="text-right font-bold text-orange" style="font-size: 10px; border-top: 2px solid #E65C00;">LABA KOTOR PERIODE INI</td>
                <td colspan="2" class="text-right font-bold text-orange" style="font-size: 11px; border-top: 2px solid #E65C00;">Rp {{ number_format($labaKotor, 0, ',', '.') }}</td>
            </tr>
        </tfoot>
    </table>
