    ...
    <div class="max-w-6xl mx-auto space-y-6 animate-[fadeIn_0.5s_ease-in-out] w-full min-w-0">
        ...
        <div class="card-animasi-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
            ...
            <form action="#" method="POST" class="space-y-8">
                ...
                <button type="submit"
                    class="w-full bg-[#FF0000] hover:bg-[#CC0000] text-white py-3.5 rounded-xl font-bold shadow-lg shadow-red-500/30 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2 text-lg">
        ...
        <div class="card-animasi-4 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <button type="submit"
                        class="w-full mt-4 bg-[#10B981] hover:bg-[#059669] text-white py-3.5 rounded-xl font-bold shadow-lg shadow-green-500/30 transition-all flex items-center justify-center gap-2 text-base">
