    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th class="text-right" style="width: 15%;">Total Nominal</th>
            </tr>
        </thead>
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center" style="color: #999; padding: 20px;">Tidak ada data penjualan pada periode ini.</td>
            </tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr style="background-color: #fff8f5; font-weight: bold;">
                <td colspan="6" class="text-right font-bold text-orange" style="font-size: 10px; border-top: 2px solid #E65C00;">TOTAL PENDAPATAN</td>
                <td class="text-right font-bold text-orange" style="font-size: 11px; border-top: 2px solid #E65C00;">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</td>
            </tr>
        </tfoot>
    </table>
