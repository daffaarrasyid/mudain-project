...
<div x-data="{ modalTambah: false }" class="animate-[fadeIn_0.5s_ease-in-out] w-full min-w-0">
    ...
    <div class="card-animasi-1 bg-white rounded-2xl shadow-sm border border-gray-100 mb-6 p-6 md:p-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            ...
            <h1 class="text-4xl md:text-5xl font-black text-gray-800">Rp 25.574.910</h1>
        </div>
    </div>
        ...
        <div class="w-full overflow-x-auto custom-scrollbar rounded-xl">
            <table class="w-full text-left border-collapse whitespace-nowrap min-w-[900px]">
                ...
                <tbody class="text-sm text-gray-600">
                    <tr class="border-b border-gray-50 even:bg-gray-50/70 hover:bg-orange-50/40 transition-colors animate-fade-in-up delay-100">
                    ...
                    <tr class="border-b border-gray-50 even:bg-gray-50/70 hover:bg-orange-50/40 transition-colors animate-fade-in-up delay-200">
                        <td class="px-6 py-4 font-medium text-gray-700">KS-000001</td>
                        <td class="px-6 py-4 text-gray-500">2026-04-13 13:23:09</td>
                        <td class="px-6 py-4">Pin Bros</td>
                        <td class="px-6 py-4 text-gray-600">Lunas</td>
                        <td class="px-6 py-4">Penjualan</td>
                        <td class="px-6 py-4 font-medium">1.000.000</td>
                        <td class="px-6 py-4">Taufik</td>
                    </tr>
                    <tr class="border-b border-gray-50 even:bg-gray-50/70 hover:bg-orange-50/40 transition-colors animate-fade-in-up delay-300">
                        <td class="px-6 py-4 font-medium text-gray-700">PG-00007</td>
                        <td class="px-6 py-4 text-gray-500">2026-04-13 13:23:09</td>
                        <td class="px-6 py-4">Listrik</td>
                        <td class="px-6 py-4 text-gray-600">Lunas</td>
                        <td class="px-6 py-4">Pengeluaran</td>
                        <td class="px-6 py-4 font-medium">200.000</td>
                        <td class="px-6 py-4">Taufik</td>
                    </tr>
                     <tr class="border-b border-gray-50 even:bg-gray-50/70 hover:bg-orange-50/40 transition-colors animate-fade-in-up delay-400">
                        <td class="px-6 py-4 font-medium text-gray-700">KS-000001</td>
                        <td class="px-6 py-4 text-gray-500">2026-04-13 13:23:09</td>
                        <td class="px-6 py-4">Pin Bros</td>
                        <td class="px-6 py-4 text-gray-600">Lunas</td>
                     ...
                     <tr class="border-b border-gray-50 even:bg-gray-50/70 hover:bg-orange-50/40 transition-colors animate-fade-in-up delay-500">
                        <td class="px-6 py-4 font-medium text-gray-700">KS-000001</td>
                        <td class="px-6 py-4 text-gray-500">2026-04-13 13:23:09</td>
                        <td class="px-6 py-4">Pin Bros</td>
                        <td class="px-6 py-4 text-gray-600">Kredit</td>
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="bg-gray-50 border border-gray-100 rounded-xl p-4 mb-4">
                    <p class="text-xs text-gray-500 italic">
                        <i class="fa-solid fa-circle-info text-[#E65C00] mr-1"></i> Catatan kas dari modul Penjualan/Pembelian akan masuk ke sini secara otomatis. Form ini digunakan untuk penyesuaian kas manual.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select required class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#E65C00] focus:ring-1 focus:ring-[#E65C00]">
                            <option value="Masuk">Uang Masuk (In)</option>
                            <option value="Keluar">Uang Keluar (Out)</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Kategori / Jenis</label>
                        <input type="text" placeholder="Contoh: Modal, Hibah..." required class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#E65C00] focus:ring-1 focus:ring-[#E65C00]">
                    </div>
