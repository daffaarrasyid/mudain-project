            ...
            <div class="w-full lg:w-1/2 p-8 md:p-12 lg:p-14">
                ...
                <div class="mt-12 pt-8 border-t border-gray-100">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="https://instagram.com/mudainproject_" target="_blank" class="w-10 h-10 bg-brand text-white rounded-full flex items-center justify-center text-lg shadow-md transform hover:-translate-y-1 hover:bg-[#cc4c0e] transition-all duration-300">
